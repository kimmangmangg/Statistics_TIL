...
- 기업수준의 의사결정에 필수 요인 e.g. SMS발송 판촉<br><br>

>## 1.2 머신러닝과 전통적 통계학의 차이
- 머신러닝 및 데이터 과학은  통계학의 확률적 이론과 에러를 최소화하는 원리를 기반으로 완성됨<br>
- 머신러닝은 데이터 학습, 분류, 예측 자체를 학습하도록 프로그래밍 된 것(학습, 분류, 예측을 목적으로 프로그래밍 된 것이 x)<br>
