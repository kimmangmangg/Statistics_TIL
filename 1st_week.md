...
>## 3.1 독립변수, 종속변수의 관계
<img width="744" alt="Image" src="https://github.com/user-attachments/assets/b57bd772-8917-4ec8-b242-22c1d5ce1be6" /><br>
- 독립변수(independent variable)와 종속변수(dependent variable)의 관계 = **원인과 결과** 관계
- 독립변수와 종속변수는 위와 같이 다양한 용어로 불림
- 독립변수와 종속변수는 기본적으로 상관관계를 가지고 있음
- 하지만 독립변수 간에는 상관관계가 없어야 함 !
- 변수 관계의 종류 : 인과관계, 상관관계, 독립관계, 의사관계, 양방향적 인과관계, 매개관계

>## 3.2 척도(변수의 데이터적 속성)의 종류
- 데이터 분석에 앞서 데이터를 통계적 분석이 가능하도록 객관적인 척도로 변환하는 작업이 우선되어야 함
- **질적 척도(범주형 척도)**: 명목 척도, 서열 척도
- **양적 척도(연속형 척도)**: 등간 척도, 비율 척도
	<img width="738" alt="Image" src="https://github.com/user-attachments/assets/75203435-af51-4396-a5d5-a17f5c16e530" /><br>
### **[명목척도(nominal scale)]** 
- 속성이나 범주를  구분하는 척도. 순서, 거리, 원점의 개념이 없어 가감승제는 의미없음<br> e.g. 운동선수의 등번호 숫자<br>
### **[서열척도(ordinal scale)]** 
- 속성 크기를 측정하여 대상 간의 순서관계를 측정하는 척도
- 순서(우위)에 대한 정보 포함하지만 간격에 대한 정보는 없음<br> e.g. 학급 성적 1등과 2등의 순서 정보는 있지만 1등과 2등이 몇 점 차이인지에 대한 정보는 없음<br>
### **[등간척도(interval scale)]** 
- 순서와 더불어 간격에 대한 정보를 포함하고 있는 척도
- 상대적 크기 차이를 비교할 수 있음<br> e.g. 섭씨 온도 30도는 20도보다 10도 높다고 할 수 있음
- 하지만 절대0점이 없어 곱하거나 나누는 것이 불가능<br>
### **[비율척도(ratio scale)]**
- 순서, 간격, 절대적 기준(0점)을 통한 비율 정보까지 포함하는 척도
- 가감승제 가능<br> e.g. 100kg 은 50kg의 두 배이다.<br>
<img width="743" alt="Image" src="https://github.com/user-attachments/assets/f8ff973c-fa5b-464f-b462-f6a8d90471f0" /><br>
- 독립/종속변수가 어떤 척도로 이루어져 있는가에 따라, 종속 변수의 유무에 따라 분석 방법은 달라짐<br>
...
- 산포도를 측정하는 방법
	...
	- **변동계수(CV;coefficient of variation)**: 표준편차를 산술평균으로 나눠준 값<br>
...
<img width="729" alt="Image" src="https://github.com/user-attachments/assets/943eea92-a5ce-4567-ac48-3df4f2ddab24" /><br>
...
- 하지만 각 부서의 인원수를 반영했을 때 B부서의 합격률이 더 높게 나오는 상황이 있을 수 있음(단순 통계치와는 반대의 결과)
